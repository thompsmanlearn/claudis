...
| ~~context_engineering_research~~ | — | **RETIRED B-106 (2026-05-08).** n8n workflow gzCSocUFNxTGIzSD deleted. Replaced by research orchestrator (B-096). research_articles history preserved. /run_context_research endpoint deprecated in stats_server. |
