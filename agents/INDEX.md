...
| agent_evaluator_4pillars | /evaluate | Haiku-as-judge 4-pillar evaluation (behavior_consistency, output_quality, reliability, integration_fit). GET `?agent_name=xxx` → scores 1-5 → writes to experimental_outputs. Webhook: GET /webhook/evaluate-agent. Workflow: kQ5OALBwexLQS7in. **Promoted 2026-03-30.** On probation — first 3 production runs audited. |
...
---
*Last updated: 2026-03-31 — lesson_injector enhanced with times_applied tracking; chromadb_id column added to lessons_learned; 51/96 lessons backfilled; 2 Supabase RPC functions created*
